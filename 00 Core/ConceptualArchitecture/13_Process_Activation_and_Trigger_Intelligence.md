...
- See also [17_Visual_Video_Context_as_Ambient_Evidence.md](17_Visual_Video_Context_as_Ambient_Evidence.md) — status APPROVED — Post-Baseline Conceptual Extension, a sub-extension of document 16. It states that authorized visual/video observation may likewise supply Trigger Discovery evidence only, never itself Trigger Resolution or an Authorized Consequence.
