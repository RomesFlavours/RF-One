...
- See also [17_Visual_Video_Context_as_Ambient_Evidence.md](17_Visual_Video_Context_as_Ambient_Evidence.md) — status PROPOSED — Post-Baseline Conceptual Extension, a sub-extension of document 16. It documents Visual/Video Context as one source category of Ambient Operational Context, further specializing the same Context Interpretation capability named in §6 below — it does not add a new capability and does not redefine Cognito.
