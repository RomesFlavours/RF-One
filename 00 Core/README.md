...
| ConceptualArchitecture/15_Human_Operational_State_and_Adaptive_Cognito_Interaction.md | Listed here only for discoverability — status "PROPOSED — Post-Baseline Conceptual Extension," produced after the `rf-one-2.0-baseline` tag, not yet part of the Approved 00–14 canonical set. Defines Human Operational State (temporary, contextual condition of a person at the current operational moment, distinct from stable person knowledge) and Adaptive Cognito Interaction (how Cognito's Human Interaction capability may adapt to it), including the boundary against medical diagnosis, the boundary against creating Authority, and the privacy/consent boundary for authorized physiological signals. Pending Product Owner ratification. |
