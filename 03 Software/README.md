...
| [Identity Authority and Security Architecture.md](Identity%20Authority%20and%20Security%20Architecture.md) | Who is authenticated, what mechanism proves it (AWS/Cognito), how is Authority enforced server-side, what is the RF-One Operational Signature and its confirmation levels, how does Legal Electronic Signature stay outside RF-One, how is the Audit Trail structured, and what are the security-layer, multi-tenant, environment, cloud and provider-abstraction decisions? Documented — CORE_IDENTITY_AUTHORITY_SECURITY_ARCHITECTURE. |
