...
Rechained (STEP 12A controlled integration) from its original
`down_revision = '09ed62634a09'` (the stale fork point this branch and
several others independently diverged from) to main's actual current head,
`3c7e9a2f5d81` — a pure metadata change, zero schema-effect alteration.
"""
...
down_revision: Union[str, Sequence[str], None] = '3c7e9a2f5d81'
