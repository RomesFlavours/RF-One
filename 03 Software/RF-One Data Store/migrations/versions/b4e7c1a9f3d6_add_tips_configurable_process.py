...
Revises: aa48187f696b
Create Date: 2026-09-13 00:00:00.000000

STEP 12B integration note: originally authored against `09ed62634a09` on
`feature/tips-complete` (branched before STEP 12A's Clover Correction/
Reconciliation Sync work merged to main); rechained here onto main's
current head (`aa48187f696b`) — ten Clover/Financial Model/Purchased
migrations landed on main in between, none of which this migration's own
schema effects below touch or conflict with. Schema effects unchanged from
the source branch.
...
down_revision: Union[str, Sequence[str], None] = 'aa48187f696b'
