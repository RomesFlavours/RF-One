...
Server Performance, Service Copilot and Continuous Productivity Development (the sibling Shared Domain that conceptually superseded the former Training placeholder) remain three distinct modules and are never merged (see [Performance/README.md](../../../Shared%20Domains/Performance/README.md), "Relationship to Continuous Productivity Development," which this specializes for the Server role).
