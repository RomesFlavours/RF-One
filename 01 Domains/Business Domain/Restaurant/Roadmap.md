...
- [../Domain Architecture.md](../../Domain%20Architecture.md) — cross-Domain conclusions on Restaurant's boundary, the Cross Domain / Business Domain taxonomy (§4: Selection, Training, Performance, Personnel Management, Taxation, Administration are Cross Domains; Restaurant is the Business Domain), and the remaining transversal Domain candidates (Customer Feedback, Review)
