...
**Correction (Product Owner decision — supersedes the original text below):** ownership is Source Domain / source fact vs. Compensation / economic rule, not Payroll vs. "Performance Shared Domain":
