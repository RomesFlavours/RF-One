...
- the target technical Domain's own requirements for the role (e.g. Restaurant's requirements for a Kitchen Manager — see [../Restaurant/](../../Business%20Domain/Restaurant/));
