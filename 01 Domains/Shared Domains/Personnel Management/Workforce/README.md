...
**Module:** Domain / Personnel Management (Shared Domains) / Workforce
...
Workforce answers **"who"** — the structural question of current occupancy. It is distinct from Personnel Management's other module and from the sibling Selection/Continuous Productivity Development/Performance Shared Domainss:

- [Selection](../../Selection/README.md) (sibling Shared Domains) answers "who else is a credible alternative";
- [Continuous Productivity Development](../../Continuous%20Productivity%20Development/README.md) (sibling Shared Domains) answers "how do we close an evidenced gap or capture an opportunity";
- [Performance](../../Performance/README.md) (sibling Shared Domains) answers "what did the person actually produce";
