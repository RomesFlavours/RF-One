...
**Version:** 0.3
**Status:** Draft (initial canonical foundation). Domain family: **Cross Domain** (`01 Domains/Cross Domain/Performance/`) — extracted from Personnel Management, not one of its modules; see [../../Domain Architecture.md](../../Domain%20Architecture.md) §4.
**Domain:** Performance (Cross Domain)
