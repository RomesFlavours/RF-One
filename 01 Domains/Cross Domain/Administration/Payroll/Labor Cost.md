...
`Total Employee Cost` is important to future Selection/Personnel Management (Performance/Personnel Decisions) reasoning, but Payroll does not make those decisions — see `01 Domains/Cross Domain/Administration/Payroll/README.md`, "Relationship to Personnel Management," and `../Personnel%20Cost.md` §11.
